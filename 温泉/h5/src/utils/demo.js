  ...
  issues: [
    {
      ...
      title: '周中空房率 62%',
      urgent: true,
      body: '周末满房、周一到周四空一半。同城亲子客搜「泡温泉」的量涨了 34%，但你的账号一周只出 2 条内容。',
    ...
    },
    {
      no: '02',
      title: '到店客人 61% 没进私域',
      body: '1,864 人扫了码，只有 726 加了企微。断点在汤池区——扫码的人拿不到值得留联系方式的东西。',
    ...
    },
    {
      no: '03',
      title: '会员一年只来 1.3 次',
      body: '泡完汤没有第二次消费的理由。协会统一选品的面膜货柜 + 积分抵扣，是最省力的那根钩子。',
...
const produce = {
  ...
  faces: [
    {
      label: '妈妈 正面',
      src: '/assets/img/face-mom.jpg',
    },
    {
      label: '孩子 正面',
      src: '/assets/img/face-kid.jpg',
    },
  ],
...
const assets = {
  ...
  persona: {
    ...
    eras: [
      {
        year: '2018 开业',
        src: '/assets/img/era-2018.jpg',
      },
      {
        year: '2022 改造',
        src: '/assets/img/era-2022.jpg',
      },
      {
        year: '2026 在用',
        src: '/assets/img/era-2026.jpg',
        active: true,
      },
    ],
...
const crowd = {
  ...
  funnelHint:
    '卡在「加企微」这一层。军师建议：生成的视频要加企微才能下载原片。',
  botLog: [
    {
      t: '09:00',
      s: '往「亲子泡汤群」发了今天新出的 3 条视频，17 人转发',
    },
    {
      t: '11:30',
      s: '回了 42 条「周中有没有优惠」，推了周中亲子套餐',
    },
    {
      t: '14:00',
      s: '给上周泡过汤没复购的 88 人发了面膜领取券',
    },
    {
      t: '17:20',
      s: '挑出 6 个问企业团建的人，标了「企业客户」交给你',
    },
  ],
